...
@Component({
  selector: 'app-new-health-stats',
  templateUrl: './new-health-stats.component.html',
  styleUrls: ['./new-health-stats.component.scss']
})
export class NewHealthStatsComponent implements OnInit {

  healthStatsForm!: FormGroup;
  ...
  setUpDistrictForm(): void {
    this.healthStatsForm = this.fb.group({
      'item': [''],
      'number': [''],
      'district_id': ['', Validators.required],
    });

    this.filteredDistricts = this.healthStatsForm.get('district_id')?.valueChanges
      .pipe(
        startWith(null),
  ...
  get district() {
    return this.healthStatsForm.get('district_id');
  }
