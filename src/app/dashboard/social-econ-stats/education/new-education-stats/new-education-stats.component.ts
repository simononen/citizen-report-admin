...
@Component({
  selector: 'app-new-education-stats',
  templateUrl: './new-education-stats.component.html',
  styleUrls: ['./new-education-stats.component.scss']
})
export class NewEducationStatsComponent implements OnInit {

  educationStatsForm!: FormGroup;
  ...
  setUpDistrictForm(): void {
    this.educationStatsForm = this.fb.group({
      'item': [''],
      'number': [''],
      'district_id': ['', Validators.required],
    });

    this.filteredDistricts = this.educationStatsForm.get('district_id')?.valueChanges
      .pipe(
        startWith(null),
  ...
  get district() {
    return this.educationStatsForm.get('district_id');
  }
