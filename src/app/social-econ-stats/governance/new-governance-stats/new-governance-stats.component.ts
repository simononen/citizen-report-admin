...
@Component({
  selector: 'app-new-governance-stats',
  templateUrl: './new-governance-stats.component.html',
  styleUrls: ['./new-governance-stats.component.scss']
})
export class NewGovernanceStatsComponent implements OnInit {

  governanceStatsForm!: FormGroup;
  ...
  setUpDistrictForm(): void {
    this.governanceStatsForm = this.fb.group({
      'item': [''],
      'number': [''],
      'district_id': ['', Validators.required],
    });

    this.filteredDistricts = this.governanceStatsForm.get('district_id')?.valueChanges
      .pipe(
        startWith(null),
  ...
  get district() {
    return this.governanceStatsForm.get('district_id');
  }
